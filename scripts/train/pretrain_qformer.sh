...
deepspeed --include localhost:4,5,6,7 --master_port 29501 tinyllava/train/train.py \
    ...
    --output_dir ./checkpoints/llava_factory/tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-pretrain-qformer \
    --num_train_epochs 1 \
    ...
    --run_name tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-pretrain-qformer