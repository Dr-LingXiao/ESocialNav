...
deepspeed --include localhost:4,5,6,7 --master_port $MASTER_PORT tinyllava/train/train.py \
    ...
    --output_dir ./checkpoints/llava_factory/tiny-llava-snei-lora-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-finetune-onestage \
    --num_train_epochs 20 \
    ...
    --run_name tiny-llava-snei-lora-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-finetune-onestage 
